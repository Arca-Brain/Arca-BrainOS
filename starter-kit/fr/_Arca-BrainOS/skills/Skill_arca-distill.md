...
## Déclencheur
Exécute ce workflow lorsque l'utilisateur tape la commande `arca-distill` (ou `distill` / `brain-distill`) suivie du nom ou du lien d'un fichier situé dans `0-Inbox/` (ou un de ses sous-dossiers, comme `0-Inbox/Youtube/`).
