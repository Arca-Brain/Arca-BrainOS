...
2. **Élaboration du Diagnostic d'Impact :**
   ...
   - Formule des recommandations structurées selon 3 axes :
     - **💡 Alignement / Pivot Stratégique :** Comment cette nouvelle information influence la vision à long terme du projet ou du thème.
...
3. **Phase Interactive (Validation) :**
   ...
   - Propose des choix d'actions précis.
