...
2. **Preserve Human Style (P- & L- Notes):** Do not rewrite or erase human-authored content in project (`P-`) or lesson (`L-`) notes. You may only add wikilinks `[[...]]`, update task checkboxes (`- [ ]`), or append session worklogs.
...
- `arca-create-note` -> Load `/_Arca-BrainOS/skills/Skill_arca-create-note.md`
