...
1. **Context Analysis:** Load operational memory `PATH_MEMORY` (`_Arca-BrainOS/memory.md`) to align on style and recent preferences. Load project note and linked Working Documents. Read last 2-3 session log entries.
